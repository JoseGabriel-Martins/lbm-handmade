...
const translations = {
  pt: {
    ...
    'hero.badge': 'Peças Exclusivas & Autorais',
    'hero.titulo1': 'Ponto a ponto,',
    'hero.titulo2': 'feito com afeto',
    'hero.descricao':
      'Amigurumi colecionáveis e bolsas de fio de malha, feitos um por um à mão em Portugal. Cada peça carrega dedicação, materiais escolhidos e cores feitas para você.',
    'hero.ctaColecao': 'Ver Coleção',
    'hero.ctaWhatsapp': 'Reservar no WhatsApp',
  ...
  en: {
    ...
    'hero.badge': 'Exclusive & Artisanal Pieces',
    'hero.titulo1': 'Stitch by stitch,',
    'hero.titulo2': 'made with love',
    'hero.descricao':
      'Collectible amigurumi and crochet yarn bags, each one made by hand in Portugal. Every piece carries dedication, carefully chosen materials and colours made just for you.',
    'hero.ctaColecao': 'View Collection',
    'hero.ctaWhatsapp': 'Reserve via WhatsApp',
