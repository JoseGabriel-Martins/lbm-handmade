    ...
    <article class="swiper-slide group h-auto">
      <div class="bg-white border border-areia rounded-3xl overflow-hidden shadow-sm h-full flex flex-col">
        ...
        <div class="p-5 flex flex-col flex-1">
          ...
          <p class="mt-1 text-sm text-espresso/60 leading-relaxed">${material}</p>
          <a href="${whatsapp}" target="_blank" rel="noopener"
             class="mt-4 inline-flex items-center justify-center gap-2 bg-caramelo text-white text-sm font-semibold px-4 py-2.5 rounded-full hover:bg-espresso transition-colors">
